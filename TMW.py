...
parser.add_argument("--Wallet_name","-wn",type=str)
...
#print(transfer_reference)
if args.Wallet_name == "Equitel" :
 sig=source_account_number+transfer_amount+transfer_currency_code+transfer_reference
else :
 sig=transfer_amount+transfer_currency_code+transfer_reference+source_account_number
#print(sig)
...
payload ={
   ...
   "destination": {
      ...
      "mobileNumber": args.destination_account_number,
